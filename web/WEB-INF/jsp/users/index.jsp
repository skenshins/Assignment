                ...
                <div id="top">
                    <spring:form action="user.htm" modelAttribute="user" method="POST">
                        <div style="float: left; margin-left: 50px;">   
                            <label style="font-size: 20px; font-weight: 900;">Tên đăng nhập:</label>   
                            <spring:input id="input1" path="username"/>  
                        </div>  
                        <div style="float: left; margin-left: 50px;">   
                            <label style="font-size: 20px; font-weight: 900;">Mật khẩu:</label>  
                            <spring:input id="input1" path="password"/>  
                        </div>   
                        <div style="float: left; margin-left: 50px;">   
                            <label style="font-size: 20px; font-weight: 900;">Họ và tên:</label>  
                            <spring:input id="input1" path="fullname"/>  
                        </div>  
